...
export default function DealclosedCardsList() {
  const cardsData: DealclosedCardProps[] = [
    {
      title: "ByteBridge",
      description:
  ...
  return (
    <div className="flex flex-col gap-4 p-1 max-w-md mx-auto">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-medium">Deal Closed</h1>
