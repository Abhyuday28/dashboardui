      ...
      <CardContent className="pt-0">
        ...
        <div className="mt-4 flex items-center justify-between text-sm text-muted-foreground">
          <div className="flex items-center gap-1 border-2 border-solid rounded-md p-1 ">
            <Calendar className="h-4 w-4 border-2 border-solid rounded-md p-1" />
            <span>{date}</span>
          </div>
...
export default function NegotiationCardsList() {
  const cardsData: NegotiationCardProps[] = [
    {
      title: "SkillUp Hub",
      description:
    ...
    },
    {
      title: "Thera Well",
      description:
        "Platform for psychological support and consultations",
      date: "No due date",
      comments: 1,
      links: 3,
      location: "540 Realty Blvd, Miami, FL 33132",
    ...
    },
    {
      title: "SwiftCargo",
      description:
        "International transportation of chemical goods",
      date: "23 Apr",
      comments: 4,
      links: 7,
      location: "540 Realty Blvd, Miami, FL 33132",
  ...
  return (
    <div className="flex flex-col gap-4 p-1 max-w-md mx-auto">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-medium">Negotiation</h1>
      ...
      {cardsData.map((card, index) => (
        <NegotiationCard key={index} {...card} />
      ))}
    </div>
  )
}
