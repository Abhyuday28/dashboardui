...
export default function OffersentCardsList() {
  const cardsData: OffersentCardProps[] = [
    {
      title: "FitLife Nutrition",
      description:
        "Nutritious food and nutraceuticals for individuals",
      date: "24 Mar",
      comments: 2,
      links: 1,
    ...
    },
    {
      ...
      description:
        "Modern educational platform for professional development",
      date: "30 Mar",
      comments: 4,
      links: 7,
      location: "540 Realty Blvd, Miami, FL 33132",
  ...
  return (
    <div className="flex flex-col gap-4 p-1 max-w-md mx-auto">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-medium">Offer Sent</h1>
